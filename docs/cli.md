...
management, and system tasks. Support commands for recipe authoring and
automation remain callable directly, but are hidden from default root help and
shell completions to keep the day-to-day surface small.
