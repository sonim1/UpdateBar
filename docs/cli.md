...
management, and system tasks. Advanced item-management, configuration, and
support commands for recipe authoring and automation remain callable directly,
but are hidden from default root help and shell completions to keep the
