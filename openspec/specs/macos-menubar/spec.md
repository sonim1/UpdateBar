# macos-menubar Specification

## Purpose
Define the native macOS menu bar presentation, including status display,
user-triggered actions, TUI launch behavior, and packaged tool resolution.
## Requirements
...
- **THEN** it SHALL show actions for Check Now, Refresh Status, Update Selected, Update All Approved Outdated, approve/revoke command fields, Open TUI, Open Config, View Logs, and Quit when those actions are available
