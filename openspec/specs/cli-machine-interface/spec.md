# cli-machine-interface Specification

## Purpose
Define UpdateBar's stable machine-readable CLI contracts for JSON output,
JSONL progress streams, exit codes, cancellation, and subprocess binary
resolution.
## Requirements
